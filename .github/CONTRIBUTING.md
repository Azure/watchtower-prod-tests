# Contributing to Azure Functions Project Watchtower
First, thank you for contributing to the Azure Functions Project Watchtower repository!
...
#### Forking the Azure/watchtower-prod-tests repository

If you don't have contributor [`Azure/watchtower-prod-tests`](https://github.com/Azure/watchtower-prod-tests/) repository, we ask that you fork the repository and submit your Pull Request from there. We block PRs from forks to go through E2E tests, however, we will cherry-picked PRs once they pass unit tests to validate the E2E tests. [Here's a guide to forks in GitHub](https://guides.github.com/activities/forking/).
...
You can find all of the pull requests that have been opened in the [Pull Request](https://github.com/Azure/watchtower-prod-tests/pulls) section of the repository.

To open your own pull request, click [here](https://github.com/Azure/watchtower-prod-tests/compare). When creating a pull request, keep the following in mind:
...
Often when a pull request is created with a large number of files changed and/or a large number of lines of code added and/or removed, GitHub will have a difficult time opening up the changes on their site. This forces the Azure watchtower-prod-tests team to use separate software to do a code review on the pull request.
